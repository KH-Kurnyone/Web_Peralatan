...
<title>Input Data Penambahan Peralatan</title>
@section('content')
    <div class="pagetitle">
        <h1>
            ...
            </a> Input Data Penambahan Peralatan
        </h1>
        <nav>
            <ol class="breadcrumb">
                    ...
                    <form action="">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input id="merek_peralatan" type="text" name="" class="form-control mb-2"
                                placeholder="Masukan Merek Peralatan" tabindex="2">
                        </div>
                        <div class="col-lg-12">
                            {{-- Masukan Nama Ruangan --}}
                        ...
                        <div class="col-lg-12">
                            ...
                            <input id="tanggal" type="date" name="" class="form-control mb-2"
                                placeholder="Masukan Tanggal" tabindex="5">
                        </div>
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-primary px-5" tabindex="6">Simpan <i
