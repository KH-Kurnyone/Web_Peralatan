...
<title>Data Penambahan Peralatan</title>
@section('content')
    <div class="pagetitle">
        <h1><i class="bi bi-plus-circle"></i> Data Penambahan Peralatan</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section">
        <div class="d-lg-flex mb-3">
            <div class="mt-4 mb-2">
                <a href="/penambahan_peralatan/add" class="btn btn-primary px-5"><i class="bi bi-plus-lg"></i> Tambah</a>
            </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/penambahan_peralatan/edit" class="btn btn-warning"><i
                                                class="bi bi-pencil-square"></i></a>
                                        <button class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#penambahan_peralatan"><i
                                                class="bi bi-trash3-fill"></i></button>
                                    </td>
                                </tr>
                                <!-- Modal Delete -->
                                <div class="modal fade" id="penambahan_peralatan" tabindex="-1"
