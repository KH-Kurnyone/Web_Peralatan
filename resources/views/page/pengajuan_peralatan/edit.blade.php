...
<title>Edit Data Pengajuan Peralatan</title>
@section('content')
    <div class="pagetitle">
        <h1>
            ...
            </a> Edit Data Pengajuan Peralatan
        </h1>
        <nav>
            <ol class="breadcrumb">
                ...
                <div class="card-body py-4">
                    <form action="">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                {{-- Edit Nama Pengaju --}}
                                <label for="nama_pengaju" class="text-dark">Nama Pengaju</label>
                                <input id="nama_pengaju" type="text" name="" class="form-control mb-2"
                                    placeholder="Edit Nama Pengaju" tabindex="3">
                            </div>
                            <div class="col-lg-6">
                                {{-- Edit Nama Ruangan --}}
