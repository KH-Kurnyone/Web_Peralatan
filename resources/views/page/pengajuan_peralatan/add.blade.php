...
<title>Input Pengajuan Peralatan</title>
@section('content')
    <div class="pagetitle">
        <h1>
            <a href="/pengajuan_peralatan" class="text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    class="bi bi-arrow-left mb-1" viewBox="0 0 16 16">
                    <path fill-rule="evenodd"
                        d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8" />
                </svg>
            </a> Input Pengajuan Peralatan
        </h1>
        <nav>
            <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input id="nama_karyawan" type="text" name="" class="form-control mb-2"
                                    placeholder="Masukan Nama Karyawan" tabindex="2">
                            </div>
                            <div class="col-lg-6">
                                ...
                                <input id="ruangan_project" type="text" name="" class="form-control mb-2"
                                    placeholder="Masukan Ruangan Project" tabindex="3">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input id="jumlah_peralatan" type="text" name="" class="form-control mb-2"
                                    placeholder="Masukan Jumlah Peralatan" tabindex="4">
                            </div>
                            <div class="col-lg-6">
                                {{-- Masukan No. Whatsapp --}}
                                <label for="no_whatsapp" class="text-dark">No. Whatsapp</label>
                                <input id="no_whatsapp" type="number" name="" class="form-control mb-2"
                                    placeholder="Masukan No. Whatsapp" tabindex="5">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input id="status" type="text" name="" class="form-control mb-2"
                                    placeholder="Masukan Status" tabindex="6">
                            </div>
                            <div class="col-lg-6">
                                {{-- Masukan Tanggal --}}
                                <label for="tanggal" class="text-dark">Tanggal</label>
                                <input id="tanggal" type="date" name="" class="form-control mb-2"
                                    placeholder="Masukan Tanggal" tabindex="7">
                            </div>
                        </div>
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-primary px-5" tabindex="8">Simpan <i
